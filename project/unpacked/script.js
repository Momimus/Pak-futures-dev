...
(function() {
      ...
      $.ajax({
        ...
        success: function(json) {
          ...
          posts.forEach(function(post) {
            ...
            // Check if this is premium-jobs or senior-jobs section
            var container = swiperEl.closest('.job-carousel-container');
            if (container && (container.classList.contains('premium-jobs') || container.classList.contains('senior-jobs'))) {
              img.style.cssText = 'width: 160px !important; height: 160px !important; max-width: 160px !important; max-height: 160px !important; object-fit: cover !important; display: block !important;';
            }
  ...
  function applySectionStyles() {
    ...
    premiumContainers.forEach(function(container) {
      // Container styles - Gold gradient
      container.style.cssText += 'background: linear-gradient(135deg, #FFF4E6 0%, #FFE0B2 50%, #FFCC80 100%) !important; border-left: 5px solid #F4A900 !important; border-top: 1px solid #F4A900 !important; border-right: 1px solid #ebebf3 !important; border-bottom: 1px solid #ebebf3 !important; border-radius: 12px !important; box-shadow: 0 6px 25px rgba(244, 169, 0, 0.2) !important; padding: 35px 30px !important; max-width: 1200px !important; margin: 0 auto !important; display: block !important; visibility: visible !important; opacity: 1 !important;';
      
      // Header styles
      var header = container.querySelector('.job-carousel-header');
      if (header) {
        header.style.cssText += 'display: flex !important; justify-content: space-between !important; align-items: center !important; margin-bottom: 30px !important; padding-bottom: 15px !important; border-bottom: 1px solid #F4A900 !important;';
      }
      
      // Title styles - Show title with proper styling (red/orange)
      var title = container.querySelector('.job-carousel-title');
      if (title) {
        title.style.cssText += 'font-size: 26px !important; font-weight: 700 !important; margin: 0 !important; color: #E67E22 !important; letter-spacing: -0.5px !important; display: block !important; visibility: visible !important; opacity: 1 !important; background: none !important;';
      }
      ...
      // View All button styles - Gold
      var viewAll = container.querySelector('.job-carousel-view-all');
      if (viewAll) {
        viewAll.style.cssText += 'font-size: 14px !important; font-weight: 600 !important; text-decoration: none !important; padding: 8px 16px !important; border-radius: 6px !important; color: #F4A900 !important; border: 2px solid #F4A900 !important; background: rgba(244, 169, 0, 0.1) !important; transition: all 0.3s ease !important;';
      }
      
      // Card styles
      var cards = container.querySelectorAll('.job-card');
      cards.forEach(function(card) {
        card.style.cssText += 'width: 220px !important; flex-shrink: 0 !important; background: #fff !important; border: 1px solid #d1fae5 !important; border-radius: 10px !important; overflow: hidden !important; box-shadow: 0 3px 10px rgba(244, 169, 0, 0.08) !important; transition: all 0.3s ease !important;';
      });
      
      // Arrow styles - Premium (gold)
      var prevArrow = container.querySelector('.job-carousel-prev');
      var nextArrow = container.querySelector('.job-carousel-next');
      if (prevArrow) {
        prevArrow.style.cssText += 'width: 36px !important; height: 36px !important; background: #ffffff !important; border: 2px solid #F4A900 !important; border-radius: 50% !important; color: #F4A900 !important; position: absolute !important; left: 5px !important; top: 50% !important; transform: translateY(-50%) !important; z-index: 15 !important; display: flex !important; align-items: center !important; justify-content: center !important; cursor: pointer !important; box-shadow: 0 3px 10px rgba(244, 169, 0, 0.25) !important; visibility: visible !important; opacity: 1 !important; font-size: 12px !important;';
        prevArrow.setAttribute('data-arrow-size', '12px');
      }
      if (nextArrow) {
        nextArrow.style.cssText += 'width: 36px !important; height: 36px !important; background: #ffffff !important; border: 2px solid #F4A900 !important; border-radius: 50% !important; color: #F4A900 !important; position: absolute !important; right: 5px !important; top: 50% !important; transform: translateY(-50%) !important; z-index: 15 !important; display: flex !important; align-items: center !important; justify-content: center !important; cursor: pointer !important; box-shadow: 0 3px 10px rgba(244, 169, 0, 0.25) !important; visibility: visible !important; opacity: 1 !important; font-size: 12px !important;';
    ...
    allCards.forEach(function(card) {
      ...
      if (cardImage) {
        // Check if this is premium-jobs or senior-jobs
        var container = card.closest('.job-carousel-container');
        if (container && (container.classList.contains('premium-jobs') || container.classList.contains('senior-jobs'))) {
          cardImage.style.cssText += 'width: 100% !important; height: 180px !important; display: flex !important; align-items: center !important; justify-content: center !important; background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%) !important; padding: 8px !important; border-bottom: 1px solid #f0f0f0 !important; position: relative !important; overflow: hidden !important;';
        } else {
          cardImage.style.cssText += 'width: 100% !important; height: 180px !important; display: flex !important; align-items: center !important; justify-content: center !important; background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%) !important; padding: 8px !important; border-bottom: 1px solid #f0f0f0 !important; position: relative !important; overflow: hidden !important;';
        }
      }
